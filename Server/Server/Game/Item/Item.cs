    ...
    public class Item
    {
        ...
        public static Item MakeItem(ItemDb itemDb)
        {
            ...
            if(item !=null)
            {
                ...
                item.ReqStr = itemDb.ReqStr;
                item.ReqDex = itemDb.ReqStr;
                item.ReqInt = itemDb.ReqInt;
                item.ReqLuk = itemDb.ReqLuk;
                item.ReqLev = itemDb.ReqLev;
                item.ReqPop = itemDb.ReqPop;

                item.UpgradeSlot = itemDb.UpgradeSlot;
                item.Str = itemDb.Str;
                item.Dex = itemDb.Dex;
                item.Int = itemDb.Int;
                item.Luk = itemDb.Luk;
                item.Hp = itemDb.Hp;
                item.Mp = itemDb.Mp;
                item.WAtk = itemDb.WAtk;
                item.MAtk = itemDb.MAtk;
                item.WDef = itemDb.WDef;
                item.MDef = itemDb.MDef;
                item.Speed = itemDb.Speed;
                item.AtkSpeed = itemDb.AtkSpeed;
                item.Durability = itemDb.Durability;
                item.Enhance = itemDb.Enhance;
                item.WPnt = itemDb.WPnt;
                item.MPnt = itemDb.MPnt;
